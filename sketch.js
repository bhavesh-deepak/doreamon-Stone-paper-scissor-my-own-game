...
function preload(){
  ...
  bkI  = loadAnimation("blue.jpg","green.jpg","pink.jpg","teal.jpg","yellow.jpg");
  ...
  playerI = loadImage("nobita.png");

  computerI = loadImage("shizuka.png");
...
function setup() {
  ...
  computer=createSprite(0+200,height/2,15,100);
